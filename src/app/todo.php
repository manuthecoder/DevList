        ...
        <div class="card">
            <div class="card-content waves-effect" onclick=\'todo('.json_encode($row['id']).', this)\'>
             ...
             <div class="card-action">
                <a href="#!" onclick="this.style.display=\'none\';$(\'#__AJAX_LOADER\').load(\'wip-task.php?id='.$row['id'].'\');document.getElementById(\'workInProgress_container\').appendChild(this.parentElement.parentElement)"><i class="material-icons">work</i></a>
...
<a class="btn-floating btn-large blue-grey darken-3" style="position:fixed;bottom:20px;right:20px;z-index:2" onclick="document.getElementById('add_popup').style.display = 'block';document.getElementById('__popup').style.display = 'block';document.getElementById('add_priority').focus();document.getElementById('add_name').focus()">
    <i class="large material-icons">add</i>
</a>
<style>
    #add_popup {position:fixed;top:0;left:0;transition: all .2s;width:100%;display:none;background: rgba(0,0,0,0.3);height:100%;z-index:99999999;animation: overlay .2s forwards}
...
<div id="add_popup" onclick='this.style.display = "none";document.getElementById("__popup").style.display = "none"'></div>
